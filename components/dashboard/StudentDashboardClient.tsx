  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-cyan-500/30">
        ...
        <div className="flex items-center gap-3">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <div>
              ...
              <span className="text-[10px] text-cyan-400 font-mono ml-1.5 px-1.5 py-0.5 rounded bg-cyan-950/80 border border-cyan-500/30">
                Dashboard
              </span>
            </div>
          </Link>
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
        ...
        <section className="bg-gradient-to-br from-slate-900 via-slate-900/90 to-cyan-950/40 border border-slate-800 rounded-2xl p-6 sm:p-8 relative overflow-hidden shadow-xl">
            ...
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              {learning.nextLesson ? (
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-semibold text-sm transition-all shadow-lg shadow-cyan-500/20 hover:scale-[1.02]"
                >
                ...
                <Link
                  href="/practice"
                  className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-purple-500 hover:bg-purple-400 text-slate-950 font-semibold text-sm transition-all shadow-lg shadow-purple-500/20 hover:scale-[1.02]"
                >
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-4 py-3 rounded-xl bg-slate-800/80 hover:bg-slate-700 text-slate-300 border border-slate-700 text-sm font-medium transition-colors"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h2 className="text-base font-semibold text-white">Learning Progress</h2>
                    <p className="text-xs text-slate-400">DSA Foundations Path</p>
                  </div>
                </div>
            ...
            <Link
              href="/paths/dsa-foundations"
              className="text-xs font-mono text-cyan-400 hover:text-cyan-300 flex items-center gap-1 transition-colors self-start"
            >
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h2 className="text-base font-semibold text-white">Practice Progress</h2>
                    <p className="text-xs text-slate-400">Interactive Coding & Tracing Challenges</p>
                  </div>
                </div>
            ...
            <Link
              href="/practice"
              className="text-xs font-mono text-purple-400 hover:text-purple-300 flex items-center gap-1 transition-colors self-start"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between space-y-4">
            <div>
              ...
              {learning.nextLesson ? (
                ...
                <div className="space-y-1">
                  <h3 className="text-lg font-bold text-white">All Lessons Completed!</h3>
            ...
            {learning.nextLesson ? (
              <Link
                href={`/paths/dsa-foundations/${learning.nextLesson.slug}`}
                className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 text-xs font-semibold transition-all shadow-md self-start"
              >
              ...
              <Link
                href="/paths/dsa-foundations"
                className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold transition-all self-start"
              >
          ...
          <section className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 flex flex-col justify-between space-y-4">
            <div>
              <div className="flex items-center gap-2 mb-2 text-purple-400 text-xs font-mono font-semibold uppercase tracking-wider">
                <Target className="w-4 h-4" />
              ...
              {practice.nextChallenge ? (
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] px-2 py-0.5 rounded bg-purple-950/60 border border-purple-500/30 text-purple-300 font-mono capitalize">
                ...
                <div className="space-y-1">
                  <h3 className="text-lg font-bold text-white">All Challenges Completed!</h3>
                  <p className="text-xs text-slate-400">
            ...
            {practice.nextChallenge ? (
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-purple-500 hover:bg-purple-400 text-slate-950 text-xs font-semibold transition-all shadow-md self-start"
              >
        ...
        <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-4">
          ...
          {recentActivity.length === 0 ? (
            <div className="p-8 text-center rounded-xl bg-slate-950/40 border border-slate-800/80 space-y-2">
              <p className="text-sm text-slate-400">No recent learning activity yet.</p>
              <p className="text-xs text-slate-400">
                Start your first lesson in{" "}
                <Link href="/paths/dsa-foundations" className="text-cyan-400 hover:underline">
                  DSA Foundations
                </Link>{" "}
            ...
            <div className="divide-y divide-slate-800/60">
              {recentActivity.slice(0, 8).map((item) => (
                <Link
                  key={item.id}
                  href={item.href}
                  className="flex items-center justify-between py-3 px-2 rounded-lg hover:bg-slate-800/40 transition-colors group"
                >
                  <div className="flex items-center gap-3">
                    <div
          ...
          <section className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-semibold text-white">Recent Workbench Runs</h2>
              </div>
              <span className="text-xs text-slate-400 font-mono">
              ...
              {recentExecutions.map((exec) => (
                ...
                >
                  <div className="space-y-1 truncate pr-3">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-slate-200 truncate">{exec.label}</span>
                  ...
                  <Link
                    href="/"
                    className="shrink-0 px-2.5 py-1 rounded bg-slate-900 hover:bg-slate-800 text-cyan-400 hover:text-cyan-300 font-medium transition-colors"
                  >
                    Open
                  </Link>
                </div>
        ...
        <section className="pt-6 border-t border-slate-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-xs text-slate-400">
          <div>
            <p className="font-medium text-slate-300">Student Progress Persistence</p>
            <p className="text-slate-400">
              Stored securely in your local browser storage (<code className="text-cyan-400">prism_progress</code>).
            </p>
          </div>

          <button
            onClick={() => setShowResetModal(true)}
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg bg-rose-950/30 hover:bg-rose-950/60 text-rose-400 border border-rose-500/30 hover:border-rose-500/50 transition-colors self-start sm:self-auto cursor-pointer"
          >
          ...
          >
            <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl">
              <div className="flex items-center gap-3 text-rose-400">
                <div className="w-10 h-10 rounded-xl bg-rose-950/60 border border-rose-500/30 flex items-center justify-center">
                  <AlertTriangle className="w-5 h-5" />
                </div>
                <div>
                  <h3 id="reset-modal-title" className="text-base font-bold text-white">
                    Reset Student Progress?
                  </h3>
                  <p className="text-xs text-slate-400">This action will clear all progress records.</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-rose-600 hover:bg-rose-500 text-white text-xs font-semibold transition-colors shadow-lg shadow-rose-600/20 cursor-pointer"
                >
                  Confirm Reset
                </button>
              </div>
