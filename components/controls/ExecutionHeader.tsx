    ...
    <>
      <header className="flex flex-wrap items-center justify-between gap-4 px-6 py-3 bg-slate-950 border-b border-slate-800 shadow-md">
        ...
        {executionIds.length > 0 && (
          <div className="flex items-center gap-1.5 bg-slate-900/90 border border-slate-800 p-1 rounded-lg font-mono text-xs overflow-x-auto max-w-md">
            {executionIds.map((id) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1 rounded-md transition-all whitespace-nowrap ${
                    isActive
                      ? isBranch
                        ? "bg-purple-900/80 border border-purple-500/50 text-purple-200 font-bold shadow-sm"
                        : "bg-cyan-900/80 border border-cyan-500/50 text-cyan-200 font-bold shadow-sm"
